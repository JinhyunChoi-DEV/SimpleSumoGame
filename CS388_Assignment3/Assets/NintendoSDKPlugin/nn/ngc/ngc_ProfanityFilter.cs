...
namespace nn.ngc
{
    public sealed partial class ProfanityFilter : IDisposable
    {
        ...
        {
            NormalizationOption_NoOption = 0,
            NormalizationOption_UnicodeNormalization = (1 << 0),
            NormalizationOption_SimilarForm = (1 << 1)
        }
        ...
        public void SetNormalizationOption(NormalizationOption option)
        {
            SetNormalizationOption(_profanityFilter, option);
        }
        ...
        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_ngc_SetNormalizationOption")]
        private static extern void SetNormalizationOption(IntPtr profanityFilter, NormalizationOption option);
    }
}
#endif
